  ...
  registerNavbarEvent: function() {
    ...
    Fluid.utils.listenScroll(function() {
      ...
      if (navbar.offset().top > 600) {
        $('.top-nav-collapse').css('background','rgba(47,65,84,0.7)')
      }else if(navbar.offset().top > 450){
        $('.top-nav-collapse').css('background','rgba(47,65,84,0.4)');
      } else{
        $('.top-nav-collapse').css('background','rgba(47,65,84,0.1)');
      }
      //避免透明度过高
      if (navbar.offset().top > 0) {
        navbar.removeClass('navbar-dark');
